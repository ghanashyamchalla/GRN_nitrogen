...
function GRN_EvaluateModels_AR1(params0, script_name, varargin)
...
% GRN_SaveResultsText(params, fullfile(dir_res,file_res), pNet);
%dlmwrite(fullfile(dir_res,file_res), wAverage, '-append');
% Exit program.
% exit
